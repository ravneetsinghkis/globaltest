...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-12">
        <div class="">
        <div class="mb-3" style="text-align: right;"><a href="/list-merchant" class=" btn btn-primary btn-sm text-gray-500">View All Merchants</a></div>
        </div>
            <div class="card">
                <div class="card-header">{{ __('Create Merchant') }}</div>
                ...
                <div class="card-body">
                    ...
                    @endif
                    <form  method="POST" action="{{ url('merchant') }}" enctype="multipart/form-data" class="needs-validation">
                        @csrf
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="mb-3 col-md-6">
                                    ...
                                    <input class="form-control" type="file" id="brandlogo" name="brandlogo" value="" accept="image/*" autofocus="" required>
                                </div>
                                <div class="mb-3 col-md-6">
                                ...
                                <div class="mt-2">
                                    <button type="submit" class="button-create me-2 btn-primary">Save Merchant</button>
                                </div>
                            </div>
                        </div>
                    </form>
